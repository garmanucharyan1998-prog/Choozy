...
export const enOverrides = {
  ...
  productDetail: {
    ...
    specsExtended: {
      ...
      warranty: "Warranty:",
      antutu: "AnTuTu:",
      geekbenchSingle: "Geekbench 6 (single-core):",
      geekbenchMulti: "Geekbench 6 (multi-core):",
  ...
  shopAccount: {
    ...
    products: {
      ...
      refreshedAria: "Product refreshed",
      refreshedShort: "Refreshed",
      ...
      staleHint:
        'A listing is removed automatically if you do not click "Refresh" within {{days}} days.',
      refreshedToday: "Today",
      refreshedDaysAgo: "{{count}} d ago",
      expiry: {
        daysLeft: "{{count}} d left",
        overdue: "Past due",
      },
      attention: {
        body: "Listings about to be removed: {{count}} — under the {{days}}-day rule.",
        show: "Show them",
        refreshAll: "Refresh all",
      },
      searchLabel: "Search products",
      searchPlaceholder: "Title, category, configuration",
      searchClear: "Clear search",
      filters: {
        groupAria: "Product filters",
        all: "All",
        inStock: "In stock",
      ...
      deleteConfirm: {
        ...
        titleMany: "Delete {{count}} products?",
        body: "The listing will be removed from your shop. This cannot be undone.",
        bodyMany: "The listings will be removed from your shop. This cannot be undone.",
        confirm: "Delete",
      },
      placeholders: {
      ...
      empty: {
        ...
        body: "This is where you add and manage your listings: price, availability, configuration and colors.",
        filteredTitle: "No matches",
        filteredBody: "Change the search or clear the filters to see the rest of your products.",
      },
      messages: {
        ...
        productsRefreshed: "Products refreshed: {{count}}.",
        priceUpdated: "Price updated.",
        autoRemoved: "Unrefreshed products removed: {{count}}.",
        productRemoved: "Product removed.",
        productsRemoved: "Products removed: {{count}}.",
      },
    ...
    messages: {
      ...
      avatarTooLarge: "Image is too large (max 200 KB).",
      avatarNotAnImage: "Choose an image file.",
      avatarFailed: "That file could not be read. Try another one.",
      saveFailed: "That change could not be saved. It will be gone after a reload.",
      dismissStatus: "Dismiss notification",
    },
  },
  footer: {
  ...
  auth: {
    ...
    logoutConfirmBody: "You will need to sign in again to get back into your account.",
    logoutConfirmSubmit: "Log out",
  ...
  comparePage: {
    ...
    scrollHint: "Swipe the table to see the other columns",
    needSecond: "Add one more product to start comparing.",
    sections: {
      overview: "Overview",
      display: "Display",
    ...
    strip: {
      heading: "Products being compared",
      aria: "The products being compared",
      ratingAria: "rating out of 5",
    },
    controls: {
      scopeAria: "What to show in the table",
      showAll: "All specifications",
    ...
    keyDifferences: {
      ...
      intro: "The figures the selected products differ on the most.",
      none: "No meaningful difference in the numbers — these products are very close.",
      note: "Only figures the catalog knows a better end for are listed here.",
      seeAll: "Show all differences ({{count}})",
    },
    bestPrices: {
      heading: "Best prices",
      intro: "The lowest price for each product across shops in Armenia.",
      cheapestBadge: "Lowest price",
      shopCount: "Shops: {{count}}",
      saveUpTo: "Save up to {{amount}}",
      noOffers: "No offers",
      viewOffers: "See all offers",
    },
    specs: {
      heading: "Specification table",
      intro: "Every specification, in groups — press a group heading to fold it away.",
      tableCaption: "Specification comparison for the selected products",
    },
    shops: {
      intro:
        "Every shop's price for every product. Use a column's button to sort the rows by that product's price.",
      tableCaption: "Shop prices for the selected products",
    },
    rows: {
      price: "Price from",
      brand: "Manufacturer",
    ...
    radar: {
      ...
      intro: "Each product's strengths and weaknesses in one picture.",
    ...
    advantages: {
      sectionHeading: "Which one to choose",
      sectionIntro:
        "Each product's measured advantages, with the values they rest on.",
