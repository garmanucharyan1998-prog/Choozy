import choozyMainLogoWhite from "../../assets/Logos/choozyMainLogoWhite.svg";
        ...
        <div className="flex flex-col gap-[30px] mb-5 sm:items-center md:flex-row md:justify-between md:items-start md:gap-0 md:mb-0">
          <div className="flex flex-col gap-5">
            ...
            <div className="flex gap-4">
              <a href="#" className="text-white no-underline transition-opacity duration-300 hover:opacity-80">
          ...
          <nav className="flex flex-col gap-4 w-full sm:gap-5 md:flex-row md:gap-10 md:w-auto md:flex-1 md:justify-end lg:gap-20 lg:px-20">
            ...
            <div className="flex flex-col gap-[10px] items-center text-center min-w-0 sm:gap-3 md:gap-4 md:items-stretch md:text-left md:min-w-[150px] lg:min-w-[200px]">
              ...
              <a href="#" className="flex items-center gap-2 text-white no-underline text-xs mr-auto transition-opacity duration-300 hover:opacity-80 md:text-sm md:mr-0">
