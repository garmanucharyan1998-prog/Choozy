    ...
    <section className="flex justify-center gap-5 mb-10 lg:my-[120px]" aria-label={"Մեր Մասին"}>
      <article className="flex flex-col text-center items-center gap-8 cont-width-default lg:grid lg:grid-cols-2 lg:text-left lg:items-center">
        <div className="flex flex-col justify-center box-border bg-section-bg p-3.5 h-full rounded-[32px] max-h-[280px] md:p-8 lg:p-9 lg:max-h-none">
          <h2 className="flex mr-auto text-lg my-2 font-semibold md:text-xl lg:text-[2rem] lg:mb-4 lg:mt-0">
            {"Մեր Մասին"}
          </h2>
          ...
          <a
            href="/about"
            role="button"
            className="flex w-fit mr-auto mt-2.5 px-3 py-2.5 bg-navy text-white text-sm no-underline rounded-pill font-medium leading-none tracking-normal transition-colors duration-300 hover:bg-navy-light hover:shadow-[#15214760_0_0_10px] lg:text-base lg:px-4 lg:py-3.5 lg:mt-0"
          >
            {"Իմանալ Ավելին"}
          </a>
        </div>
